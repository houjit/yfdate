...
// 遍历节气表
$Yfdate = Yfdate::fromDate(new DateTime());
...
// 遍历日吉神（宜趋）
foreach ($Yfdate->getDayJiShen() as $js) {
  echo $js . ' ';
}
echo "\n";

// 遍历时辰宜
foreach ($Yfdate->getTimeYi() as $yi) {
  echo $yi . ' ';
}
echo "\n";

// 八字
$baZi = $Yfdate->getEightChar();
echo $baZi . ' ';
echo "\n";
...
// 时辰吉神方位
echo $Yfdate->getTimePositionFu() . "\n";
echo $Yfdate->getTimePositionXi() . "\n";
echo $Yfdate->getTimePositionCai() . "\n";
echo $Yfdate->getTimePositionYinGui() . "\n";
echo $Yfdate->getTimePositionYangGui() . "\n";

echo $Yfdate->getTimePositionFuDesc() . "\n";
echo $Yfdate->getTimePositionXiDesc() . "\n";
echo $Yfdate->getTimePositionCaiDesc() . "\n";
echo $Yfdate->getTimePositionYinGuiDesc() . "\n";
echo $Yfdate->getTimePositionYangGuiDesc() . "\n";
...
$Yfdate = $solar->getYfdate();
// 甲午
echo $Yfdate->getYearXun() . "\n";

// 旬空(空亡)
// 辰巳
echo $Yfdate->getYearXunKong() . "\n";
// 午未
echo $Yfdate->getMonthXunKong() . "\n";
// 戌亥
echo $Yfdate->getDayXunKong() . "\n";
...
// 数九
$Yfdate = Yfdate::fromDate(new DateTime());
echo $Yfdate->getShuJiu() . "\n";

// 三伏
$solar = Solar::fromYmd(2020, 7, 26);
$Yfdate = $solar->getYfdate();
echo $Yfdate->getFu()->toFullString() . "\n";

// 六曜
$Yfdate = Yfdate::fromDate(new DateTime());
echo $Yfdate->getLiuYao() . "\n";

// 物候
echo $Yfdate->getWuHou() . "\n";

// 时辰福神方位
$times = $Yfdate->getTimes();
