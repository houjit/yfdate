...
class Yfdate
{
  ...
  private function __construct($YfdateYear, $YfdateMonth, $YfdateDay, $hour, $minute, $second, $solar, $y)
  {
    $this->year = $YfdateYear;
    $this->month = $YfdateMonth;
    $this->day = $YfdateDay;
    $this->hour = $hour;
    $this->minute = $minute;
    $this->second = $second;
   ...
   * @return Yfdate
   */
  public static function fromYmd($YfdateYear, $YfdateMonth, $YfdateDay)
  {
    return Yfdate::fromYmdHms($YfdateYear, $YfdateMonth, $YfdateDay, 0, 0, 0);
  }
  ...
  {
    $y = YfdateYear::fromYear($YfdateYear);
    $m = $y->getMonth($YfdateMonth);
    $noon = Solar::fromJulianDay($m->getFirstJulianDay() + $YfdateDay - 1);
    $solar = Solar::fromYmdHms($noon->getYear(), $noon->getMonth(), $noon->getDay(), $hour, $minute, $second);
    return new Yfdate($YfdateYear, $YfdateMonth, $YfdateDay, $hour, $minute, $second, $solar, $y);
  }
  ...
  public static function fromDate($date)
  {
    ...
    $ly = YfdateYear::fromYear($currentYear);
    $YfdateYear = 0;
    $YfdateMonth = 0;
    $YfdateDay = 0;
    foreach ($ly->getMonths() as $m) {
      ...
      if ($days < $m->getDayCount()) {
        $YfdateYear = $m->getYear();
        $YfdateMonth = $m->getMonth();
        $YfdateDay = $days + 1;
        break;
      }
    }
    return new Yfdate($YfdateYear, $YfdateMonth, $YfdateDay, $hour, $minute, $second, Solar::fromDate($date), $ly);
  }
  ...
  private function computeJieQi($y)
  {
    ...
    for ($i = 0, $j = count(Yfdate::$JIE_QI_IN_USE); $i < $j; $i++) {
      $this->jieQi[Yfdate::$JIE_QI_IN_USE[$i]] = Solar::fromJulianDay($jds[$i]);
    }
  }
  ...
  private function computeMonth()
  {
    ...
    $size = count(Yfdate::$JIE_QI_IN_USE);

    //序号：大雪以前-3，大雪到小寒之间-2，小寒到立春之间-1，立春之后0
    $index = -3;
    for ($i = 0; $i < $size; $i += 2) {
      $end = $this->jieQi[Yfdate::$JIE_QI_IN_USE[$i]];
    ...
    $this->monthZhiIndex = (($index < 0 ? $index + 12 : $index) + YfdateUtil::$BASE_MONTH_ZHI_INDEX) % 12;
    ...
    $this->monthZhiIndexExact = (($index < 0 ? $index + 12 : $index) + YfdateUtil::$BASE_MONTH_ZHI_INDEX) % 12;
  }
  ...
  {
    $this->timeZhiIndex = YfdateUtil::getTimeZhiIndex(($this->hour < 10 ? '0' : '') . $this->hour . ':' . ($this->minute < 10 ? '0' : '') . $this->minute);
  ...
  {
    return YfdateUtil::$GAN[$this->yearGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$GAN[$this->yearGanIndexByLiChun + 1];
  }
  ...
  {
    return YfdateUtil::$GAN[$this->yearGanIndexExact + 1];
  }
  ...
  {
    return YfdateUtil::$ZHI[$this->yearZhiIndex + 1];
  }
  ...
  {
    return YfdateUtil::$ZHI[$this->yearZhiIndexByLiChun + 1];
  }
  ...
  {
    return YfdateUtil::$ZHI[$this->yearZhiIndexExact + 1];
  }
  ...
  {
    return YfdateUtil::$GAN[$this->monthGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$GAN[$this->monthGanIndexExact + 1];
  }
  ...
  {
    return YfdateUtil::$ZHI[$this->monthZhiIndex + 1];
  }
  ...
  {
    return YfdateUtil::$ZHI[$this->monthZhiIndexExact + 1];
  }
  ...
  {
    return YfdateUtil::$GAN[$this->dayGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$GAN[$this->dayGanIndexExact + 1];
  }
  ...
  {
    return YfdateUtil::$GAN[$this->dayGanIndexExact2 + 1];
  }
  ...
  {
    return YfdateUtil::$ZHI[$this->dayZhiIndex + 1];
  }
  ...
  {
    return YfdateUtil::$ZHI[$this->dayZhiIndexExact + 1];
  }
  ...
  {
    return YfdateUtil::$ZHI[$this->dayZhiIndexExact2 + 1];
  }
  ...
  {
    return YfdateUtil::$SHENG_XIAO[$this->yearZhiIndex + 1];
  }
  ...
  {
    return YfdateUtil::$SHENG_XIAO[$this->yearZhiIndexByLiChun + 1];
  }
  ...
  {
    return YfdateUtil::$SHENG_XIAO[$this->yearZhiIndexExact + 1];
  }
  ...
  {
    return YfdateUtil::$SHENG_XIAO[$this->monthZhiIndex + 1];
  }
  ...
  {
    return YfdateUtil::$SHENG_XIAO[$this->dayZhiIndex + 1];
  }
  ...
  {
    return YfdateUtil::$SHENG_XIAO[$this->timeZhiIndex + 1];
  }
  ...
  {
    return ($this->month < 0 ? '闰' : '') . YfdateUtil::$MONTH[abs($this->month)];
  }
  ...
  {
    return YfdateUtil::$DAY[$this->day];
  }
  ...
  {
    return YfdateUtil::$ZHI[$this->timeZhiIndex + 1];
  }
  ...
  {
    return YfdateUtil::$GAN[$this->timeGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$SEASON[abs($this->month)];
  }
  ...
  {
    for ($i = 0, $j = count(Yfdate::$JIE_QI_IN_USE); $i < $j; $i += 2) {
      $key = Yfdate::$JIE_QI_IN_USE[$i];
      $d = $this->jieQi[$key];
  ...
  {
    for ($i = 1, $j = count(Yfdate::$JIE_QI_IN_USE); $i < $j; $i += 2) {
      $key = Yfdate::$JIE_QI_IN_USE[$i];
      $d = $this->jieQi[$key];
      if ($d->getYear() === $this->solar->getYear() && $d->getMonth() === $this->solar->getMonth() && $d->getDay() === $this->solar->getDay()) {
        return $this->convertJieQi($key);
  ...
  {
    return YfdateUtil::$XIU[$this->getDayZhi() . $this->getWeek()];
  }
  ...
  public function getFestivals()
  {
    ...
    if (!empty(YfdateUtil::$FESTIVAL[$key])) {
      $l[] = YfdateUtil::$FESTIVAL[$key];
    }
  ...
  public function getOtherFestivals()
  {
    $l = array();
    $key = $this->month . '-' . $this->day;
    if (!empty(YfdateUtil::$OTHER_FESTIVAL[$key])) {
      foreach (YfdateUtil::$OTHER_FESTIVAL[$key] as $f) {
        $l[] = $f;
      }
    }
    $jq = $this->jieQi['清明'];
    ...
    $jq = $this->jieQi['立春'];
    $offset = 4 - $jq->getYfdate()->getDayGanIndex();
    if ($offset < 0) {
      $offset += 10;
    }
  ...
  {
    return YfdateUtil::$PENG_ZU_GAN[$this->dayGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$PENG_ZU_ZHI[$this->dayZhiIndex + 1];
  }
  ...
  {
    return YfdateUtil::$POSITION_XI[$this->dayGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getDayPositionXi()];
  }
  ...
  {
    return YfdateUtil::$POSITION_XI[$this->timeGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getTimePositionXi()];
  }
  ...
  {
    return YfdateUtil::$POSITION_YANG_GUI[$this->dayGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getDayPositionYangGui()];
  }
  ...
  {
    return YfdateUtil::$POSITION_YANG_GUI[$this->timeGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getTimePositionYangGui()];
  }
  ...
  {
    return YfdateUtil::$POSITION_YIN_GUI[$this->dayGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getDayPositionYinGui()];
  }
  ...
  {
    return YfdateUtil::$POSITION_YIN_GUI[$this->timeGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getTimePositionYinGui()];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getDayPositionFuBySect($sect)];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getTimePositionFuBySect($sect)];
  }
  ...
  {
    return YfdateUtil::$POSITION_CAI[$this->dayGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getDayPositionCai()];
  }
  ...
  {
    return YfdateUtil::$POSITION_CAI[$this->timeGanIndex + 1];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getTimePositionCai()];
  }
  ...
  public function getYearPositionTaiSuiBySect($sect)
  {
    ...
    return YfdateUtil::$POSITION_TAI_SUI_YEAR[$yearZhiIndex];
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getYearPositionTaiSuiBySect($sect)];
  }

  protected function _getMonthPositionTaiSui($monthZhiIndex, $monthGanIndex)
  {
    $m = $monthZhiIndex - YfdateUtil::$BASE_MONTH_ZHI_INDEX;
    if ($m < 0) {
      $m += 12;
    }
    switch ($m) {
      ...
      case 11:
        ...
        break;
      default:
        $p = YfdateUtil::$POSITION_GAN[$monthGanIndex];
    }
    return $p;
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getMonthPositionTaiSuiBySect($sect)];
  }
  ...
  protected function _getDayPositionTaiSui($dayInGanZhi, $yearZhiIndex)
  {
    if (strpos('甲子,乙丑,丙寅,丁卯,戊辰,已巳',$dayInGanZhi) !== false) {
      ...
      $p = YfdateUtil::$POSITION_TAI_SUI_YEAR[$yearZhiIndex];
    }
    return $p;
  }
  ...
  {
    return YfdateUtil::$POSITION_DESC[$this->getDayPositionTaiSuiBySect($sect)];
  }
  ...
  {
    return YfdateUtil::$CHONG[$this->dayZhiIndex];
  }
  ...
  {
    return YfdateUtil::$CHONG[$this->timeZhiIndex];
  }
  ...
  {
    return YfdateUtil::$CHONG_GAN[$this->dayGanIndex];
  }
  ...
  {
    return YfdateUtil::$CHONG_GAN[$this->timeGanIndex];
  }
  ...
  {
    return YfdateUtil::$CHONG_GAN_TIE[$this->dayGanIndex];
  }
  ...
  {
    return YfdateUtil::$CHONG_GAN_TIE[$this->timeGanIndex];
  }
  ...
  {
    return YfdateUtil::$SHA[$this->getDayZhi()];
  }
  ...
  {
    return YfdateUtil::$SHA[$this->getTimeZhi()];
  }
  ...
  {
    return YfdateUtil::$NAYIN[$this->getYearInGanZhi()];
  }
  ...
  {
    return YfdateUtil::$NAYIN[$this->getMonthInGanZhi()];
  }
  ...
  {
    return YfdateUtil::$NAYIN[$this->getDayInGanZhi()];
  }
  ...
  {
    return YfdateUtil::$NAYIN[$this->getTimeInGanZhi()];
  }
  ...
  public function getZhiXing()
  {
    ...
    return YfdateUtil::$ZHI_XING[$offset + 1];
  }
  ...
  public function getDayTianShen()
  {
    ...
    $offset = YfdateUtil::$ZHI_TIAN_SHEN_OFFSET[$monthZhi];
    return YfdateUtil::$TIAN_SHEN[($this->dayZhiIndex + $offset) % 12 + 1];
  }
  ...
  public function getTimeTianShen()
  {
    ...
    return YfdateUtil::$TIAN_SHEN[($this->timeZhiIndex + $offset) % 12 + 1];
  }
  ...
  {
    return YfdateUtil::$TIAN_SHEN_TYPE[$this->getDayTianShen()];
  }
  ...
  {
    return YfdateUtil::$TIAN_SHEN_TYPE[$this->getTimeTianShen()];
  }
  ...
  {
    return YfdateUtil::$TIAN_SHEN_TYPE_LUCK[$this->getDayTianShenType()];
  }
  ...
  {
    return YfdateUtil::$TIAN_SHEN_TYPE_LUCK[$this->getTimeTianShenType()];
  }
  ...
  {
    return YfdateUtil::$POSITION_TAI_DAY[YfdateUtil::getJiaZiIndex($this->getDayInGanZhi())];
  }
  ...
  public function getMonthPositionTai()
  {
    ...
    return YfdateUtil::$POSITION_TAI_MONTH[$this->month - 1];
  }
  ...
  {
    return YfdateUtil::getDayYi($this->getMonthInGanZhiExact(), $this->getDayInGanZhi());
  }
  ...
  {
    return YfdateUtil::getTimeYi($this->getDayInGanZhiExact(), $this->getTimeInGanZhi());
  }
  ...
  {
    return YfdateUtil::getDayJi($this->getMonthInGanZhiExact(), $this->getDayInGanZhi());
  }
  ...
  {
    return YfdateUtil::getTimeJi($this->getDayInGanZhiExact(), $this->getTimeInGanZhi());
  }
  ...
  {
    return YfdateUtil::getDayJiShen($this->getMonth(), $this->getDayInGanZhi());
  }
  ...
  {
    return YfdateUtil::getDayXiongSha($this->getMonth(), $this->getDayInGanZhi());
  }
  ...
  {
    return YfdateUtil::$YUE_XIANG[$this->getDay()];
  }

  protected function _getYearNineStar($yearInGanZhi)
  {
    $index = YfdateUtil::getJiaZiIndex($yearInGanZhi) + 1;
    $yearOffset = 0;
    if ($index != YfdateUtil::getJiaZiIndex($this->getYearInGanZhi()) + 1) {
      $yearOffset = -1;
    }
  ...
  public function _getMonthNineStar($yearZhiIndex, $monthZhiIndex)
  {
    ...
    $n = 27 - ($index * 3);
    if ($monthZhiIndex < YfdateUtil::$BASE_MONTH_ZHI_INDEX) {
      $n -= 3;
    }
  ...
  public function getDayNineStar()
  {
    ...
    $dongZhiIndex = YfdateUtil::getJiaZiIndex($dongZhi->getYfdate()->getDayInGanZhi());
    $dongZhiIndex2 = YfdateUtil::getJiaZiIndex($dongZhi2->getYfdate()->getDayInGanZhi());
    $xiaZhiIndex = YfdateUtil::getJiaZiIndex($xiaZhi->getYfdate()->getDayInGanZhi());
    if ($dongZhiIndex > 29) {
  ...
  {
    $conditions = array();
    for ($i = 0, $j = count(Yfdate::$JIE_QI_IN_USE) / 2; $i < $j; $i++) {
      $conditions[] = Yfdate::$JIE_QI_IN_USE[$i * 2];
    }
  ...
  public function getNextQiByWholeDay($wholeDay)
  {
    $conditions = array();
    for ($i = 0, $j = count(Yfdate::$JIE_QI_IN_USE) / 2; $i < $j; $i++) {
      $conditions[] = Yfdate::$JIE_QI_IN_USE[$i * 2 + 1];
    }
    return $this->getNearJieQi(true, $conditions, $wholeDay);
  }
  ...
  public function getEightChar()
  {
    if (null == $this->eightChar) {
      $this->eightChar = EightChar::fromYfdate($this);
    }
  ...
  {
    return $this->solar->next($days)->getYfdate();
  }
  ...
  {
    return YfdateUtil::getXun($this->getYearInGanZhi());
  }
  ...
  {
    return YfdateUtil::getXun($this->getYearInGanZhiByLiChun());
  }
  ...
  {
    return YfdateUtil::getXun($this->getYearInGanZhiExact());
  }
  ...
  {
    return YfdateUtil::getXunKong($this->getYearInGanZhi());
  }
  ...
  {
    return YfdateUtil::getXunKong($this->getYearInGanZhiByLiChun());
  }
  ...
  {
    return YfdateUtil::getXunKong($this->getYearInGanZhiExact());
  }
  ...
  {
    return YfdateUtil::getXun($this->getMonthInGanZhi());
  }
  ...
  {
    return YfdateUtil::getXun($this->getMonthInGanZhiExact());
  }
  ...
  {
    return YfdateUtil::getXunKong($this->getMonthInGanZhi());
  }
  ...
  {
    return YfdateUtil::getXunKong($this->getMonthInGanZhiExact());
  }
  ...
  {
    return YfdateUtil::getXun($this->getDayInGanZhi());
  }
  ...
  {
    return YfdateUtil::getXun($this->getDayInGanZhiExact());
  }
  ...
  {
    return YfdateUtil::getXun($this->getDayInGanZhiExact2());
  }
  ...
  {
    return YfdateUtil::getXunKong($this->getDayInGanZhi());
  }
  ...
  {
    return YfdateUtil::getXunKong($this->getDayInGanZhiExact());
  }
  ...
  {
    return YfdateUtil::getXunKong($this->getDayInGanZhiExact2());
  }
  ...
  {
    return YfdateUtil::getXun($this->getTimeInGanZhi());
  }
  ...
  {
    return YfdateUtil::getXunKong($this->getTimeInGanZhi());
  }
  ...
  public function getShuJiu()
  {
    ...
    return new ShuJiu(YfdateUtil::$NUMBER[intval($days / 9) + 1] . '九', $days % 9 + 1);
  }
  ...
  public function getFu()
  {
    ...
    $add = 6 - $xiaZhi->getYfdate()->getDayGanIndex();
    if ($add < 0) {
      $add += 10;
    }
    $add += 20;
  ...
  {
    return YfdateUtil::$LIU_YAO[(abs($this->month) + $this->day - 2) % 6];
  }
  ...
  public function getWuHou()
  {
    ...
    $days = ExactDate::getDaysBetweenDate($startCalendar, $currentCalendar);
    return YfdateUtil::$WU_HOU[($offset * 3 + floor($days / 5)) % count(YfdateUtil::$WU_HOU)];
  }
  ...
  public function getHou()
  {
    ...
    $max = count(YfdateUtil::$HOU) - 1;
    $offset = floor($days / 5);
    if ($offset > $max) {
      $offset = $max;
    }
    return $jieQi->getName() . ' ' . YfdateUtil::$HOU[$offset];
  }

  public function getDayLu()
  {
    $gan = YfdateUtil::$LU[$this->getDayGan()];
    $zhi = null;
    if (!empty(YfdateUtil::$LU[$this->getDayZhi()])) {
      $zhi = YfdateUtil::$LU[$this->getDayZhi()];
    }
    $lu = $gan . '命互禄';
    if (null != $zhi) {
      $lu .= ' ' . $zhi . '命进禄';
  ...
  /**
   * 获取时辰
   * @return YfdateTime 时辰
   */
  public function getTime()
  {
    return YfdateTime::fromYmdHms($this->year, $this->month, $this->day, $this->hour, $this->minute, $this->second);
  }

  /**
   * 获取时辰列表
   * @return YfdateTime[] 时辰列表
   */
  public function getTimes()
  {
    $l = array();
    $l[] = YfdateTime::fromYmdHms($this->year, $this->month, $this->day, 0, 0, 0);
    for ($i = 0; $i < 12; $i++) {
      $l[] = YfdateTime::fromYmdHms($this->year, $this->month, $this->day, ($i + 1) * 2 - 1, 0, 0);
    }
    return $l;
  }
